...
export const login = async (req, res) => {
    ...
    try {
        ...
        if (!isMatch) {
            return res.json({ success: false, message: 'Invalid email or password' }); // ✅ fixed
        }
...
export const sendResetOtp = async (req, res) => {
    ...
    try {
        ...
        user.resetOtp = otp;
        user.resetOtpExpireAt = Date.now() + 15 * 60 * 1000; // ✅ correct field
...
export const resetPassword = async (req, res) => {
    ...
    try {
        ...
        user.resetOtp = '';        // ✅ fixed comma to dot
        ...
        return res.json({ success: false, message: error.message }); // ✅ success not return
    }
}